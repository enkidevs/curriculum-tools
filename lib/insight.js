  ...
  render() {
    ...
    if (this.links != null && this.links.length > 0) {
      ...
      for (let i in this.links) {
        markdown += `  - '[${this.links[i].name}](${this.links[i].url}){${this.links[i].nature || 'website'}}'\n\n`
      }
    }
    ...
    // Practice Question
    if (this.practiceQuestion != null && this.practiceQuestion.text != null) {
    ...
    // Review Question
    if (this.revisionQuestion != null && this.revisionQuestion.text != null) {
...
`---
## Quiz
### ${this.quizQuestion.headline}

${this.quizQuestion.question}
`

      for (let i in this.quizQuestion.answers) {
        markdown += `\n* ${this.quizQuestion.answers[i]}`
      }
      markdown += '\n'
    }
