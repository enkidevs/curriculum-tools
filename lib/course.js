...
module.exports = class Course extends Content {
  ...
  addStandard (standard) {
    this.externalStandards.push(standard)
  }
  ...
  getOrderedWorkouts () {
    ...
    const sectionsWorkoutSlugs = Object.values(this.sections).reduce(
      (acc, val) => acc.concat(val),
      []
    )

    sectionsWorkoutSlugs.forEach(workoutSlug =>
      orderedWorkouts.push(workoutsSlugMap.get(workoutSlug))
    )
