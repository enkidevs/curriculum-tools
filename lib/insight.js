...
module.exports = class Insight extends Content {
  ...
  getPracticeQuestion () {
    ...
    return practiceQuestionNode
      ? extractQuestionFromAstNode(practiceQuestionNode)
      : undefined
  }
  ...
  getRevisionQuestion () {
    ...
    return revisionQuestionNode
      ? extractQuestionFromAstNode(revisionQuestionNode)
      : undefined
  }
  ...
  getQuiz () {
    ...
    return quizNode
      ? extractQuizFromAstNode(quizNode)
      : undefined
  }
