...
`;
  ...
  readCourseFile({topic, path}) {
    ...
    // If topic is new
    if(!this.topics[topicSlug]) {
      this.topics[topicSlug] = new Topic({});
      this.topics[topicSlug].name = topic;
      this.topics[topicSlug].slug = topicSlug;
    }
