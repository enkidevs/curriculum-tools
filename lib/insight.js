...
module.exports = class Insight extends Content {
  ...
  setQuiz (quizObj) {
    const ast = this.ast
    // TODO: BUG: Construct a quiz node to insert here
  ...
  setFootnotes (footnotesText = '') {
    const ast = this.ast
    // TODO: BUG: write helper function to create footer node in place here
    visit(ast, { type: 'section', name: 'Footnotes' }, node => node)
    this.ast = ast
  }
