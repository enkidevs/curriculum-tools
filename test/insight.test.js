...
describe('Insight', () => {
  ...
  test('parses the title from the raw insight text', () => {
    testInsights.forEach(insight => {
      expect(insight.getTitle()).toBeDefined()
    })

    let titles = testInsights.map(insight => insight.getTitle())
  ...
  test('parses the slug from the filename', () => {
    ...
    let slugs = testInsights.map(insight => insight.slug)
  ...
  test('parses the content section from the raw insight text', () => {
    testInsights.forEach(insight => {
      expect(insight.getContent()).toBeDefined()
    })

    // let contentArr = testInsights.map(insight => insight.getContent())
  ...
  test('parses the Practice Question question', () => {
    let practiceQuestionTextArr = testInsights
    ...
    // expect(practiceQuestionTextArr).toEqual(expect.arrayContaining([
  ...
  test('parses the Revision Question question', () => {
    let revisionQuestionArr = testInsights
  ...
  test('parses the Revision Question answers', () => {
    ...
    let revisionQuestionArr = revisionQuestionHavingInsights.map(insight => insight.revisionQuestion.answers)
